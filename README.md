...
**Vigenere / Vernam / Ceasar Ciphers** - Functions for encrypting and decrypting data messages. Then send them to a friend. [[Rnhmjoj (Python)]](https://github.com/Rnhmjoj/Crittografia/blob/master/Esempio.py)  [[tel (Haskell)]](https://github.com/tel/Projects/blob/master/Text/Vigenere.hs) [[petehuang (Ruby)]](https://github.com/petehuang/Projects/blob/master/Text/cipher.rb)
...
**Markdown to HTML Converter** - Converts Markdown formatted text into HTML files. Implement basic tags like `p`, `strong`, `em` etc. *Optional: Implement all tags from [Markdown Syntax Docs](daringfireball.net/projects/markdown/syntax).* [[Drhealsgood (Python)]](https://github.com/Drhealsgood/miniprojects/blob/master/text_projects/auto_markup/markup.py)
