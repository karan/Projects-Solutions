...
**Coin Flip Simulation** - Write some code that simulates flipping a single coin however many times the user decides. The code should record the outcomes and count the number of tails and heads. [[scottdchris (Python)]](https://github.com/scottdchris/CoinFlip)
...
**RSS Feed Creator** - Given a link to RSS/Atom Feed, get all posts and display them. [[sriniavireddy (python)]] (https://github.com/sriniavireddy/scripts-and-solutions/tree/master/Text/RSSfeedparser) [[coderickl4m4r (Python)]](https://github.com/coderickl4m4r/Projects/blob/master/Text/rss.py)
...
**Bank Account Manager** - Create a class called Account which will be an abstract class for three other classes called CheckingAccount, SavingsAccount and BusinessAccount. Manage credits and debits from these accounts through an ATM style program. [[jbruno2 (python)]](https://github.com/jbruno2/Simple-Programs-and-Solutions/blob/master/C%2B%2B/Bank%20Account%20Class.py)
...
**Page Scraper** - Create an application which connects to a site and pulls out all links, or images, and saves them to a list. *Optional: Organize the indexed content and don’t allow duplicates. Have it put the results into an easily searchable index file.* [[mouradmourafiq (python)]](https://github.com/mouradmourafiq/pages-jaunes-maroc) [[coderickl4m4r (Python)]](https://github.com/coderickl4m4r/Projects/blob/master/Web/scraper.py)
